<script lang="ts">
	...
	import WpsBreakdownChart from '$lib/components/wps-breakdown-chart.svelte';
...
<div class="flex flex-1 flex-col gap-4">
	<h2 class="text-2xl font-bold tracking-tight">WPs</h2>
	...
	{#if stats.csvError}
		<p class="rounded-md border border-destructive/50 bg-destructive/10 p-4 text-sm text-destructive">
			{stats.csvError}
		</p>
	{/if}
	...
	<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
		<div class="rounded-md border border-border p-4">
			...
			<WpsBreakdownChart recent={stats.usersRecent} stale={usersStale} none={usersNone} />
		</div>
