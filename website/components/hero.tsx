      ...
      <div className="flex flex-col items-start justify-start gap-y-5 font-dm-mono text-white">
        ...
        <div className="flex items-center justify-start gap-x-5">
          <a
            ...
            className="hover:bg-HCBlue ml-auto mt-4 rounded-lg border-2 border-HCPurple bg-HCPurple px-2 py-1.5 font-dm-mono text-base font-medium text-white transition-all duration-300 hover:scale-110 hover:shadow-lg md:mt-0 md:text-lg 2xl:text-xl"
          >
            Join Nest!
          </a>
          ...
          <a
            ...
            className="mt-4 rounded-lg border-2 border-HCPurple px-2 py-1.5 font-dm-mono text-base font-medium text-HCPurple transition-all duration-300 hover:scale-110 hover:bg-HCPurple hover:text-white md:mt-0 md:text-lg 2xl:text-xl flex items-center"
          >
            Read the Docs <FaArrowRight className="ml-2 mt-1" />
          </a>
        </div>
        <pre className="w-min text-xs lg:hidden">{`
            ██████████████████████████      
          ██                        ████    
        ████████████████████████████  ██    
        ██                        ██  ██    
      ...
      >
        ...
        <pre
          className={`${isExpanded ? "opacity-100" : "opacity-0"
            } transition-all duration-300 hidden lg:block text-sm 2xl:text-base`}
        >{`
